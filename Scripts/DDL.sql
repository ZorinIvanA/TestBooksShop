...
create table if not exists common.books
(
	id serial not null
		constraint books_pk
			primary key,
	...
	type integer,
	present_on_storage integer
);

alter table common.books owner to postgres;

create unique index if not exists books_id_uindex
	on common.books (id);

create table if not exists common.sales
(
	book_id integer not null
		constraint sales_books__fk
			references common.books,
...
alter table common.sales owner to postgres;

create unique index if not exists sales_sale_id_uindex
	on common.sales (sale_id);
...
create unique index if not exists pg_statistic_ext_data_stxoid_index
...
create or replace view information_schema."_pg_foreign_data_wrappers"(authorization_identifier, fdwoptions, fdwowner, foreign_data_wrapper_catalog, foreign_data_wrapper_language, foreign_data_wrapper_name, oid) as
-- missing source code
;

create or replace view information_schema."_pg_foreign_servers"(authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_name, foreign_server_catalog, foreign_server_name, foreign_server_type, foreign_server_version, oid, srvoptions) as
-- missing source code
;
...
create or replace view information_schema."_pg_foreign_tables"(authorization_identifier, foreign_server_catalog, foreign_server_name, foreign_table_catalog, foreign_table_name, foreign_table_schema, ftoptions) as
-- missing source code
;

create or replace view information_schema."_pg_user_mappings"(authorization_identifier, foreign_server_catalog, foreign_server_name, oid, srvowner, umoptions, umuser) as
-- missing source code
;
...
create or replace view information_schema.attributes(attribute_default, attribute_name, attribute_udt_catalog, attribute_udt_name, attribute_udt_schema, character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision, dtd_identifier, interval_precision, interval_type, is_derived_reference_attribute, is_nullable, maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, ordinal_position, scope_catalog, scope_name, scope_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.character_sets(character_repertoire, character_set_catalog, character_set_name, character_set_schema, default_collate_catalog, default_collate_name, default_collate_schema, form_of_use) as
-- missing source code
;

create or replace view information_schema.check_constraint_routine_usage(constraint_catalog, constraint_name, constraint_schema, specific_catalog, specific_name, specific_schema) as
-- missing source code
;
...
create or replace view information_schema.collation_character_set_applicability(character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema) as
-- missing source code
;
...
create or replace view information_schema.column_column_usage(column_name, dependent_column, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_domain_usage(column_name, domain_catalog, domain_name, domain_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_options(column_name, option_name, option_value, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_privileges(column_name, grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.column_udt_usage(column_name, table_catalog, table_name, table_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.columns(character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, column_default, column_name, data_type, datetime_precision, domain_catalog, domain_name, domain_schema, dtd_identifier, generation_expression, identity_cycle, identity_generation, identity_increment, identity_maximum, identity_minimum, identity_start, interval_precision, interval_type, is_generated, is_identity, is_nullable, is_self_referencing, is_updatable, maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, ordinal_position, scope_catalog, scope_name, scope_schema, table_catalog, table_name, table_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.constraint_column_usage(column_name, constraint_catalog, constraint_name, constraint_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.constraint_table_usage(constraint_catalog, constraint_name, constraint_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.data_type_privileges(dtd_identifier, object_catalog, object_name, object_schema, object_type) as
-- missing source code
;

create or replace view information_schema.domain_constraints(constraint_catalog, constraint_name, constraint_schema, domain_catalog, domain_name, domain_schema, initially_deferred, is_deferrable) as
-- missing source code
;

create or replace view information_schema.domain_udt_usage(domain_catalog, domain_name, domain_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.domains(character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision, domain_catalog, domain_default, domain_name, domain_schema, dtd_identifier, interval_precision, interval_type, maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, scope_catalog, scope_name, scope_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.element_types(character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, collection_type_identifier, data_type, datetime_precision, domain_default, dtd_identifier, interval_precision, interval_type, maximum_cardinality, numeric_precision, numeric_precision_radix, numeric_scale, object_catalog, object_name, object_schema, object_type, scope_catalog, scope_name, scope_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;
...
create or replace view information_schema.foreign_data_wrapper_options(foreign_data_wrapper_catalog, foreign_data_wrapper_name, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_data_wrappers(authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_language, foreign_data_wrapper_name, library_name) as
-- missing source code
;

create or replace view information_schema.foreign_server_options(foreign_server_catalog, foreign_server_name, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_servers(authorization_identifier, foreign_data_wrapper_catalog, foreign_data_wrapper_name, foreign_server_catalog, foreign_server_name, foreign_server_type, foreign_server_version) as
-- missing source code
;

create or replace view information_schema.foreign_table_options(foreign_table_catalog, foreign_table_name, foreign_table_schema, option_name, option_value) as
-- missing source code
;

create or replace view information_schema.foreign_tables(foreign_server_catalog, foreign_server_name, foreign_table_catalog, foreign_table_name, foreign_table_schema) as
-- missing source code
;
...
create or replace view pg_catalog.pg_hba_file_rules(address, auth_method, database, error, line_number, netmask, options, type, user_name) as
-- missing source code
;
...
create or replace view pg_catalog.pg_locks(classid, database, fastpath, granted, locktype, mode, objid, objsubid, page, pid, relation, transactionid, tuple, virtualtransaction, virtualxid) as
-- missing source code
;

create or replace view pg_catalog.pg_matviews(definition, hasindexes, ispopulated, matviewname, matviewowner, schemaname, tablespace) as
-- missing source code
;

create or replace view pg_catalog.pg_policies(cmd, permissive, policyname, qual, roles, schemaname, tablename, with_check) as
-- missing source code
;
...
create or replace view pg_catalog.pg_replication_slots(active, active_pid, catalog_xmin, confirmed_flush_lsn, database, datoid, plugin, restart_lsn, slot_name, slot_type, temporary, xmin) as
-- missing source code
;

create or replace view pg_catalog.pg_roles(oid, rolbypassrls, rolcanlogin, rolconfig, rolconnlimit, rolcreatedb, rolcreaterole, rolinherit, rolname, rolpassword, rolreplication, rolsuper, rolvaliduntil) as
-- missing source code
;
...
create or replace view pg_catalog.pg_seclabels(classoid, label, objname, objnamespace, objoid, objsubid, objtype, provider) as
-- missing source code
;

create or replace view pg_catalog.pg_sequences(cache_size, cycle, data_type, increment_by, last_value, max_value, min_value, schemaname, sequencename, sequenceowner, start_value) as
-- missing source code
;

create or replace view pg_catalog.pg_settings(boot_val, category, context, enumvals, extra_desc, max_val, min_val, name, pending_restart, reset_val, setting, short_desc, source, sourcefile, sourceline, unit, vartype) as
-- missing source code
;
...
create or replace view pg_catalog.pg_shadow(passwd, usebypassrls, useconfig, usecreatedb, usename, userepl, usesuper, usesysid, valuntil) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_activity(application_name, backend_start, backend_type, backend_xid, backend_xmin, client_addr, client_hostname, client_port, datid, datname, pid, query, query_start, state, state_change, usename, usesysid, wait_event, wait_event_type, xact_start) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_all_indexes(idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_all_tables(analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze, last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_archiver(archived_count, failed_count, last_archived_time, last_archived_wal, last_failed_time, last_failed_wal, stats_reset) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_bgwriter(buffers_alloc, buffers_backend, buffers_backend_fsync, buffers_checkpoint, buffers_clean, checkpoint_sync_time, checkpoint_write_time, checkpoints_req, checkpoints_timed, maxwritten_clean, stats_reset) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_database(blk_read_time, blk_write_time, blks_hit, blks_read, checksum_failures, checksum_last_failure, conflicts, datid, datname, deadlocks, numbackends, stats_reset, temp_bytes, temp_files, tup_deleted, tup_fetched, tup_inserted, tup_returned, tup_updated, xact_commit, xact_rollback) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_database_conflicts(confl_bufferpin, confl_deadlock, confl_lock, confl_snapshot, confl_tablespace, datid, datname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_gssapi(encrypted, gss_authenticated, pid, principal) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_progress_cluster(cluster_index_relid, command, datid, datname, heap_blks_scanned, heap_blks_total, heap_tuples_scanned, heap_tuples_written, index_rebuild_count, phase, pid, relid) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_progress_create_index(blocks_done, blocks_total, command, current_locker_pid, datid, datname, index_relid, lockers_done, lockers_total, partitions_done, partitions_total, phase, pid, relid, tuples_done, tuples_total) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_progress_vacuum(datid, datname, heap_blks_scanned, heap_blks_total, heap_blks_vacuumed, index_vacuum_count, max_dead_tuples, num_dead_tuples, phase, pid, relid) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_replication(application_name, backend_start, backend_xmin, client_addr, client_hostname, client_port, flush_lag, flush_lsn, pid, replay_lag, replay_lsn, reply_time, sent_lsn, state, sync_priority, sync_state, usename, usesysid, write_lag, write_lsn) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_ssl(bits, cipher, client_dn, client_serial, compression, issuer_dn, pid, ssl, version) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_subscription(last_msg_receipt_time, last_msg_send_time, latest_end_lsn, latest_end_time, pid, received_lsn, relid, subid, subname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_sys_indexes(idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_sys_tables(analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze, last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count) as
-- missing source code
;
...
create or replace view pg_catalog.pg_stat_user_indexes(idx_scan, idx_tup_fetch, idx_tup_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_user_tables(analyze_count, autoanalyze_count, autovacuum_count, idx_scan, idx_tup_fetch, last_analyze, last_autoanalyze, last_autovacuum, last_vacuum, n_dead_tup, n_live_tup, n_mod_since_analyze, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read, vacuum_count) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_wal_receiver(conninfo, last_msg_receipt_time, last_msg_send_time, latest_end_lsn, latest_end_time, pid, receive_start_lsn, receive_start_tli, received_lsn, received_tli, sender_host, sender_port, slot_name, status) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_xact_all_tables(idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read) as
-- missing source code
;

create or replace view pg_catalog.pg_stat_xact_sys_tables(idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read) as
-- missing source code
;
...
create or replace view pg_catalog.pg_stat_xact_user_tables(idx_scan, idx_tup_fetch, n_tup_del, n_tup_hot_upd, n_tup_ins, n_tup_upd, relid, relname, schemaname, seq_scan, seq_tup_read) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_all_indexes(idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;
...
create or replace view pg_catalog.pg_statio_all_tables(heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit, tidx_blks_read, toast_blks_hit, toast_blks_read) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_sys_indexes(idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;
...
create or replace view pg_catalog.pg_statio_sys_tables(heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit, tidx_blks_read, toast_blks_hit, toast_blks_read) as
-- missing source code
;

create or replace view pg_catalog.pg_statio_user_indexes(idx_blks_hit, idx_blks_read, indexrelid, indexrelname, relid, relname, schemaname) as
-- missing source code
;
...
create or replace view pg_catalog.pg_statio_user_tables(heap_blks_hit, heap_blks_read, idx_blks_hit, idx_blks_read, relid, relname, schemaname, tidx_blks_hit, tidx_blks_read, toast_blks_hit, toast_blks_read) as
-- missing source code
;

create or replace view pg_catalog.pg_stats(attname, avg_width, correlation, elem_count_histogram, histogram_bounds, inherited, most_common_elem_freqs, most_common_elems, most_common_freqs, most_common_vals, n_distinct, null_frac, schemaname, tablename) as
-- missing source code
;

create or replace view pg_catalog.pg_stats_ext(attnames, dependencies, kinds, most_common_base_freqs, most_common_freqs, most_common_val_nulls, most_common_vals, n_distinct, schemaname, statistics_name, statistics_owner, statistics_schemaname, tablename) as
-- missing source code
;

create or replace view pg_catalog.pg_tables(hasindexes, hasrules, hastriggers, rowsecurity, schemaname, tablename, tableowner, tablespace) as
-- missing source code
;
...
create or replace view pg_catalog.pg_user(passwd, usebypassrls, useconfig, usecreatedb, usename, userepl, usesuper, usesysid, valuntil) as
-- missing source code
;
...
create or replace view information_schema.referential_constraints(constraint_catalog, constraint_name, constraint_schema, delete_rule, match_option, unique_constraint_catalog, unique_constraint_name, unique_constraint_schema, update_rule) as
-- missing source code
;

create or replace view information_schema.role_column_grants(column_name, grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.role_routine_grants(grantee, grantor, is_grantable, privilege_type, routine_catalog, routine_name, routine_schema, specific_catalog, specific_name, specific_schema) as
-- missing source code
;

create or replace view information_schema.role_table_grants(grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema, with_hierarchy) as
-- missing source code
;

create or replace view information_schema.role_udt_grants(grantee, grantor, is_grantable, privilege_type, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.role_usage_grants(grantee, grantor, is_grantable, object_catalog, object_name, object_schema, object_type, privilege_type) as
-- missing source code
;

create or replace view information_schema.routine_privileges(grantee, grantor, is_grantable, privilege_type, routine_catalog, routine_name, routine_schema, specific_catalog, specific_name, specific_schema) as
-- missing source code
;

create or replace view information_schema.routines(as_locator, character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, created, data_type, datetime_precision, dtd_identifier, external_language, external_name, interval_precision, interval_type, is_deterministic, is_implicitly_invocable, is_null_call, is_udt_dependent, is_user_defined_cast, last_altered, max_dynamic_result_sets, maximum_cardinality, module_catalog, module_name, module_schema, new_savepoint_level, numeric_precision, numeric_precision_radix, numeric_scale, parameter_style, result_cast_as_locator, result_cast_char_max_length, result_cast_char_octet_length, result_cast_char_set_catalog, result_cast_char_set_name, result_cast_char_set_schema, result_cast_collation_catalog, result_cast_collation_name, result_cast_collation_schema, result_cast_datetime_precision, result_cast_dtd_identifier, result_cast_from_data_type, result_cast_interval_precision, result_cast_interval_type, result_cast_maximum_cardinality, result_cast_numeric_precision, result_cast_numeric_precision_radix, result_cast_numeric_scale, result_cast_scope_catalog, result_cast_scope_name, result_cast_scope_schema, result_cast_type_udt_catalog, result_cast_type_udt_name, result_cast_type_udt_schema, routine_body, routine_catalog, routine_definition, routine_name, routine_schema, routine_type, schema_level_routine, scope_catalog, scope_name, scope_schema, security_type, specific_catalog, specific_name, specific_schema, sql_data_access, sql_path, to_sql_specific_catalog, to_sql_specific_name, to_sql_specific_schema, type_udt_catalog, type_udt_name, type_udt_schema, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.schemata(catalog_name, default_character_set_catalog, default_character_set_name, default_character_set_schema, schema_name, schema_owner, sql_path) as
-- missing source code
;

create or replace view information_schema.sequences(cycle_option, data_type, increment, maximum_value, minimum_value, numeric_precision, numeric_precision_radix, numeric_scale, sequence_catalog, sequence_name, sequence_schema, start_value) as
-- missing source code
;

create or replace view information_schema.table_constraints(constraint_catalog, constraint_name, constraint_schema, constraint_type, enforced, initially_deferred, is_deferrable, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.table_privileges(grantee, grantor, is_grantable, privilege_type, table_catalog, table_name, table_schema, with_hierarchy) as
-- missing source code
;

create or replace view information_schema.tables(commit_action, is_insertable_into, is_typed, reference_generation, self_referencing_column_name, table_catalog, table_name, table_schema, table_type, user_defined_type_catalog, user_defined_type_name, user_defined_type_schema) as
-- missing source code
;

create or replace view information_schema.transforms(group_name, specific_catalog, specific_name, specific_schema, transform_type, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.triggered_update_columns(event_object_catalog, event_object_column, event_object_schema, event_object_table, trigger_catalog, trigger_name, trigger_schema) as
-- missing source code
;

create or replace view information_schema.triggers(action_condition, action_order, action_orientation, action_reference_new_row, action_reference_new_table, action_reference_old_row, action_reference_old_table, action_statement, action_timing, created, event_manipulation, event_object_catalog, event_object_schema, event_object_table, trigger_catalog, trigger_name, trigger_schema) as
-- missing source code
;

create or replace view information_schema.udt_privileges(grantee, grantor, is_grantable, privilege_type, udt_catalog, udt_name, udt_schema) as
-- missing source code
;

create or replace view information_schema.usage_privileges(grantee, grantor, is_grantable, object_catalog, object_name, object_schema, object_type, privilege_type) as
-- missing source code
;

create or replace view information_schema.user_defined_types(character_maximum_length, character_octet_length, character_set_catalog, character_set_name, character_set_schema, collation_catalog, collation_name, collation_schema, data_type, datetime_precision, interval_precision, interval_type, is_final, is_instantiable, numeric_precision, numeric_precision_radix, numeric_scale, ordering_category, ordering_form, ordering_routine_catalog, ordering_routine_name, ordering_routine_schema, ref_dtd_identifier, reference_type, source_dtd_identifier, user_defined_type_catalog, user_defined_type_category, user_defined_type_name, user_defined_type_schema) as
-- missing source code
;

create or replace view information_schema.user_mapping_options(authorization_identifier, foreign_server_catalog, foreign_server_name, option_name, option_value) as
-- missing source code
;
...
create or replace view information_schema.view_column_usage(column_name, table_catalog, table_name, table_schema, view_catalog, view_name, view_schema) as
-- missing source code
;

create or replace view information_schema.view_routine_usage(specific_catalog, specific_name, specific_schema, table_catalog, table_name, table_schema) as
-- missing source code
;

create or replace view information_schema.view_table_usage(table_catalog, table_name, table_schema, view_catalog, view_name, view_schema) as
-- missing source code
;

create or replace view information_schema.views(check_option, is_insertable_into, is_trigger_deletable, is_trigger_insertable_into, is_trigger_updatable, is_updatable, table_catalog, table_name, table_schema, view_definition) as
-- missing source code
;

create or replace function common.get_books_by_params(_exists boolean, _types text, _mincost numeric, _maxcost numeric, _author text, _name text) returns TABLE(id integer, name character varying, author character varying, price numeric, book_type integer, storage integer)
	language plpgsql
as $$
BEGIN
...
alter function common.get_books_by_params(boolean, text, numeric, numeric, text, text) owner to postgres;

create or replace function common.add_book(_name text, _author text, _price numeric, _type integer, _storage integer) returns integer
	language plpgsql
as $$
BEGIN
...
alter function common.add_book(text, text, numeric, integer, integer) owner to postgres;

create or replace function common.sell_book(_id integer) returns void
	language plpgsql
as $$
BEGIN
...
alter function common.sell_book(integer) owner to postgres;

create or replace function common.get_sales_by_days(_startdate timestamp without time zone, _finishdate timestamp without time zone) returns TABLE(sale_dt timestamp without time zone, sold_count bigint)
	language plpgsql
as $$
BEGIN
...
alter function common.get_sales_by_days(timestamp, timestamp) owner to postgres;

create or replace function common.get_sales_by_types(_startdate timestamp without time zone, _finishdate timestamp without time zone) returns TABLE(book_type integer, sold_count bigint)
	language plpgsql
as $$
BEGIN
...
alter function common.get_sales_by_types(timestamp, timestamp) owner to postgres;
...
create or replace function pg_catalog.aclexplode(acl aclitem[], out grantee oid, out grantor oid, out is_grantable boolean, out privilege_type text)
	stable
	strict
	cost 1
	rows 10
...
create or replace function pg_catalog.cursor_to_xml(count integer, cursor refcursor, nulls boolean, tableforest boolean, targetns text)
	strict
	language internal
as -- missing source code
;
...
create or replace function pg_catalog.jsonb_insert(insert_after boolean default false, jsonb_in jsonb, path text[], replacement jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_path_exists(path jsonpath, silent boolean default false, target jsonb, vars jsonb default '{}'::jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_path_match(path jsonpath, silent boolean default false, target jsonb, vars jsonb default '{}'::jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_path_query(path jsonpath, silent boolean default false, target jsonb, vars jsonb default '{}'::jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_path_query_array(path jsonpath, silent boolean default false, target jsonb, vars jsonb default '{}'::jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_path_query_first(path jsonpath, silent boolean default false, target jsonb, vars jsonb default '{}'::jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.jsonb_set(create_if_missing boolean default true, jsonb_in jsonb, path text[], replacement jsonb)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.log10(numeric) returns numeric
	immutable
	strict
	cost 1
	language sql
...
create or replace function pg_catalog.make_interval(days integer default 0, hours integer default 0, mins integer default 0, months integer default 0, secs double precision default 0.0, weeks integer default 0, years integer default 0)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.make_timestamp(hour integer, mday integer, min integer, month integer, sec double precision, year integer)
	immutable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.make_timestamptz(hour integer, mday integer, min integer, month integer, sec double precision, year integer)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.make_timestamptz(hour integer, mday integer, min integer, month integer, sec double precision, timezone text, year integer)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog."overlaps"(time without time zone, interval, time without time zone, time without time zone) returns boolean
	immutable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(time without time zone, time without time zone, time without time zone, interval) returns boolean
	immutable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp with time zone, interval, timestamp with time zone, timestamp with time zone) returns boolean
	stable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp with time zone, timestamp with time zone, timestamp with time zone, interval) returns boolean
	stable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp without time zone, interval, timestamp without time zone, interval) returns boolean
	immutable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp without time zone, interval, timestamp without time zone, timestamp without time zone) returns boolean
	immutable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog."overlaps"(timestamp without time zone, timestamp without time zone, timestamp without time zone, interval) returns boolean
	immutable
	cost 1
	language sql
as -- missing source code
...
create or replace function pg_catalog.pg_available_extension_versions(out comment text, out name name, out relocatable boolean, out requires name[], out schema name, out superuser boolean, out version text)
	stable
	strict
	cost 10
	rows 100
...
create or replace function pg_catalog.pg_control_checkpoint(out checkpoint_lsn pg_lsn, out checkpoint_time timestamp with time zone, out full_page_writes boolean, out newest_commit_ts_xid xid, out next_multi_offset xid, out next_multixact_id xid, out next_oid oid, out next_xid text, out oldest_active_xid xid, out oldest_commit_ts_xid xid, out oldest_multi_dbid oid, out oldest_multi_xid xid, out oldest_xid xid, out oldest_xid_dbid oid, out prev_timeline_id integer, out redo_lsn pg_lsn, out redo_wal_file text, out timeline_id integer)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_control_recovery(out backup_end_lsn pg_lsn, out backup_start_lsn pg_lsn, out end_of_backup_record_required boolean, out min_recovery_end_lsn pg_lsn, out min_recovery_end_timeline integer)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_control_system(out catalog_version_no integer, out pg_control_last_modified timestamp with time zone, out pg_control_version integer, out system_identifier bigint)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_copy_logical_replication_slot(dst_slot_name name, out lsn pg_lsn, out slot_name name, src_slot_name name)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_copy_logical_replication_slot(dst_slot_name name, out lsn pg_lsn, out slot_name name, src_slot_name name, temporary boolean)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_copy_logical_replication_slot(dst_slot_name name, out lsn pg_lsn, plugin name, out slot_name name, src_slot_name name, temporary boolean)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_copy_physical_replication_slot(dst_slot_name name, out lsn pg_lsn, out slot_name name, src_slot_name name)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_copy_physical_replication_slot(dst_slot_name name, out lsn pg_lsn, out slot_name name, src_slot_name name, temporary boolean)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_create_logical_replication_slot(out lsn pg_lsn, plugin name, slot_name name, out slot_name name, temporary boolean default false)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_create_physical_replication_slot(immediately_reserve boolean default false, out lsn pg_lsn, slot_name name, out slot_name name, temporary boolean default false)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_cursor(out creation_time timestamp with time zone, out is_binary boolean, out is_holdable boolean, out is_scrollable boolean, out name text, out statement text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_event_trigger_ddl_commands(out classid oid, out command pg_ddl_command, out command_tag text, out in_extension boolean, out object_identity text, out object_type text, out objid oid, out objsubid integer, out schema_name text)
	stable
	strict
	cost 10
	rows 100
...
create or replace function pg_catalog.pg_get_object_address(out classid oid, object_args text[], object_names text[], out objid oid, out objsubid integer, type text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_get_replication_slots(out active boolean, out active_pid integer, out catalog_xmin xid, out confirmed_flush_lsn pg_lsn, out datoid oid, out plugin name, out restart_lsn pg_lsn, out slot_name name, out slot_type text, out temporary boolean, out xmin xid)
	stable
	cost 1
	rows 10
	language internal
...
create or replace function pg_catalog.pg_hba_file_rules(out address text, out auth_method text, out database text[], out error text, out line_number integer, out netmask text, out options text[], out type text, out user_name text[])
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_identify_object(classid oid, out identity text, out name text, objid oid, objsubid integer, out schema text, out type text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_identify_object_as_address(classid oid, out object_args text[], out object_names text[], objid oid, objsubid integer, out type text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_logical_slot_get_binary_changes(out data bytea, out lsn pg_lsn, options text[] default '{}'::text[], slot_name name, upto_lsn pg_lsn, upto_nchanges integer, out xid xid)
	cost 1000
	language internal
as -- missing source code
;
...
create or replace function pg_catalog.pg_logical_slot_get_changes(out data text, out lsn pg_lsn, options text[] default '{}'::text[], slot_name name, upto_lsn pg_lsn, upto_nchanges integer, out xid xid)
	cost 1000
	language internal
as -- missing source code
;
...
create or replace function pg_catalog.pg_logical_slot_peek_binary_changes(out data bytea, out lsn pg_lsn, options text[] default '{}'::text[], slot_name name, upto_lsn pg_lsn, upto_nchanges integer, out xid xid)
	cost 1000
	language internal
as -- missing source code
;
...
create or replace function pg_catalog.pg_logical_slot_peek_changes(out data text, out lsn pg_lsn, options text[] default '{}'::text[], slot_name name, upto_lsn pg_lsn, upto_nchanges integer, out xid xid)
	cost 1000
	language internal
as -- missing source code
;
...
create or replace function pg_catalog.pg_ls_archive_statusdir(out modification timestamp with time zone, out name text, out size bigint)
	strict
	cost 10
	rows 20
	language internal
...
create or replace function pg_catalog.pg_ls_tmpdir(out modification timestamp with time zone, out name text, out size bigint)
	strict
	cost 10
	rows 20
	language internal
...
create or replace function pg_catalog.pg_ls_tmpdir(out modification timestamp with time zone, out name text, out size bigint, tablespace oid)
	strict
	cost 10
	rows 20
	language internal
...
create or replace function pg_catalog.pg_mcv_list_items(out base_frequency double precision, out frequency double precision, out index integer, mcv_list pg_mcv_list, out nulls boolean[], out values text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_partition_tree(out isleaf boolean, out level integer, out parentrelid regclass, out relid regclass, rootrelid regclass)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_prepared_statement(out from_sql boolean, out name text, out parameter_types regtype[], out prepare_time timestamp with time zone, out statement text)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_prepared_xact(out dbid oid, out gid text, out ownerid oid, out prepared timestamp with time zone, out transaction xid)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_sequence_parameters(out cache_size bigint, out cycle_option boolean, out data_type oid, out increment bigint, out maximum_value bigint, out minimum_value bigint, sequence_oid oid, out start_value bigint)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.pg_show_all_file_settings(out applied boolean, out error text, out name text, out seqno integer, out setting text, out sourcefile text, out sourceline integer)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_show_replication_origin_status(out external_id text, out local_id oid, out local_lsn pg_lsn, out remote_lsn pg_lsn)
	cost 1
	rows 100
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_file(out access timestamp with time zone, out change timestamp with time zone, out creation timestamp with time zone, filename text, out isdir boolean, out modification timestamp with time zone, out size bigint)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_file(out access timestamp with time zone, out change timestamp with time zone, out creation timestamp with time zone, filename text, out isdir boolean, missing_ok boolean, out modification timestamp with time zone, out size bigint)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_get_archiver(out archived_count bigint, out failed_count bigint, out last_archived_time timestamp with time zone, out last_archived_wal text, out last_failed_time timestamp with time zone, out last_failed_wal text, out stats_reset timestamp with time zone)
	stable
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_stat_get_progress_info(cmdtype text, out datid oid, out param1 bigint, out param10 bigint, out param11 bigint, out param12 bigint, out param13 bigint, out param14 bigint, out param15 bigint, out param16 bigint, out param17 bigint, out param18 bigint, out param19 bigint, out param2 bigint, out param20 bigint, out param3 bigint, out param4 bigint, out param5 bigint, out param6 bigint, out param7 bigint, out param8 bigint, out param9 bigint, out pid integer, out relid oid)
	stable
	strict
	cost 1
	rows 100
...
create or replace function pg_catalog.pg_stop_backup(exclusive boolean, out labelfile text, out lsn pg_lsn, out spcmapfile text, wait_for_archive boolean default true)
	strict
	cost 1
	language internal
as -- missing source code
...
create or replace function pg_catalog.pg_timezone_names(out abbrev text, out is_dst boolean, out name text, out utc_offset interval)
	stable
	strict
	cost 1
	language internal
...
create or replace function pg_catalog.ts_debug(config regconfig, document text, OUT alias text, OUT description text, OUT token text, OUT dictionaries regdictionary[], OUT dictionary regdictionary, OUT lexemes text[]) returns SETOF record
	stable
	strict
	language sql
as -- missing source code
...
create or replace function pg_catalog.ts_debug(document text, OUT alias text, OUT description text, OUT token text, OUT dictionaries regdictionary[], OUT dictionary regdictionary, OUT lexemes text[]) returns SETOF record
	stable
	strict
	language sql
as -- missing source code
...
create or replace function pg_catalog.ts_stat(out ndoc integer, out nentry integer, query text, weights text, out word text)
	strict
	cost 10
	rows 10000
	language internal
...
create or replace function pg_catalog.ts_token_type(out alias text, out description text, parser_name text, out tokid integer)
	stable
	strict
	cost 1
	rows 16
...
create or replace function pg_catalog.unnest(out lexeme text, out positions smallint[], tsvector tsvector, out weights text[])
	immutable
	strict
	cost 1
	rows 10
